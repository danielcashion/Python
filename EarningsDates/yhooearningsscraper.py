...
yhoo_earnings_url = 'http://finance.yahoo.com/calendar/earnings'
yhoo_base_quote = 'https://finance.yahoo.com/quote'
...
class YahooEarningsCalendarScrapper(object):
    """
    ...
    def get_next_earnings_date(self, symbol):
        ...
        """
        url = '{0}/{1}'.format(yhoo_base_quote, symbol)
        try:
    ...
    def earnings_on(self, date):
        ...
        dated_url = '{0}?day={1}'.format(yhoo_earnings_url, date_str)
...
if __name__ == '__main__':
    ...
    yec = YahooEarningsCalendarScrapperScrapper()
